export default {
  ...
  chat: {
    ...
    nodeDataPreview: 'Node Data Source Preview',
    exitFullscreen: 'Exit Fullscreen (Esc)',
    fullscreen: 'Fullscreen',
    ultraLite: 'Ultra Lite',
    lite: 'Lite (Logic Only)',
  ...
  setting: {
    ...
    aiNodeAnalyzerDesc: 'AI Node Analyzer is a powerful Blender addon that allows users to analyze nodes in the node editor (supporting geometry nodes, shader nodes, compositor nodes, etc.) and optionally send them to AI for further analysis.',
    aiNodeAnalyzerFeatures: 'Main Features:',
    featureParseNodes: 'Parse selected node structures, including recursive parsing of node groups',
    featurePanel: 'Provides a convenient analysis panel in the node editor sidebar',
    featureNodeType: 'Supports multiple node types: geometry nodes, shader nodes, compositor nodes, etc.',
    featureAIProvider: 'Supports two AI service providers: DeepSeek and Ollama',
    featureSaveResult: 'Save parsing results to Blender text blocks for review',
    featureBackendServer: 'Includes a backend server that supports communication with external applications such as browsers',
    originalProject: 'Frontend interface based on',
    originalProjectLink: 'chatgpt-web',
    originalLicense: 'project, which is open-sourced under the MIT license.',
    originalCredit: 'Thanks to the original project author Chenzhaoyu for the contribution.',
  },
  store: {
